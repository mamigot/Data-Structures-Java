/**
 * Test10 -- test class extending {@link TestHarness}
 * <p>
 * Tests the addEdge(T n, L l, T m) method. Only creates an edge if a node
...
public class Test10 extends TestHarness {
    ...
    public boolean test() {
    	...
    	try {
			g.addEdge("hahahaha", 22, "notThere");
		} catch (InvalidOperationException e) {
			//should throw an exception
